...
n1_ls_old = n1_LS_Spa_kj1_kj2(ismembc2(ismembc2(paset_trt, LS{node}.indx),n1_indx1));
...
n1_pa=LS{node}.parent(n1_indx1(n1_loc),:);
...
for j=1:length(n1_pa)
    cmat = cmat + cmat(:,n1_pa(j))*cmat(node,:);
end
