function [sampled_graphs, LL_retain] = learn_struct_mcmc_gibbs_block2(varargin)
%learn_struct_mcmc_gibbs_block2 learning network structure by mcmc
% INPUTS:
...
t_inside_max = ceil(n/2);
even_node_flag = mod(n,2);
t=1;
sampind=1;
