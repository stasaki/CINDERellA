function [Mcmc]=flearnstruct_step(Param,savefile)
...
% only REV50 works for this script
    ...
    case  'M.REV50'
        ...
        for i=1:numtry
            ...
            [sampled_graphs, LL_retain] =...
                ...
                'nsamples',2,...
                'sample_interval', sample_interval);
            Mcmc.sampled_graphs(i)=sampled_graphs(2);
            Mcmc.LL(i)=LL_retain(2);
        end
        Mcmc.toc=toc(start);
